function [RR_RR_cumulative_distribution,RR_RR_values] = get_cumulative_distribution_from_signal(signal, Fs, time_axis);
        ...
        % 1) Signal loading phase executed earlier on (signal was passed as an argument)
